...
public class WangShiNewsActivity extends BaseActivity implements
		IReflashListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				String url = URL.WangShiNewsIp;
				httpUtl = new HttpUtl();
				if (httpUtl.hasInternet(WangShiNewsActivity.this)) {
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				// TODO Auto-generated method stub
				int pos = arg2 - 1;
				Intent inten = new Intent(WangShiNewsActivity.this,
						WebActivity.class);
